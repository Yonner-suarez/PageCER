  ...
  },
  {
    ...
    cell: (row) => (
      <select
        ...
        onChange={(e) => {
          console.log(`Pedido ${row.idPedido} cambiado a:`, e.target.value);
          // Aquí puedes llamar a la API para actualizar el estado
        }}
      >
...
export default columnsReportePedidos;
